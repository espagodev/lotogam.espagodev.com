                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                           ...
                           <div class="col-xs-12 col-sm-3 col-md-3">
                                <div class="form-group">
                                    <div class="icheck-material-info">
                                        <input type="checkbox" id="use_venta_agrupada" name="use_venta_agrupada" value="1"/>
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3">
                                <div class="form-group">
                                    <div class="icheck-material-info">
                                        <input type="checkbox" id="use_ticket_imagen" name="use_ticket_imagen" value="1"/>
                       ...
                       <div class="row">
                        <div class="col-xs-12 col-sm-3 col-md-3">
                           <div class="form-group">
                               <div class="icheck-material-info">
                                   <input type="checkbox" id="use_traslado" name="use_traslado" value="1"/>
