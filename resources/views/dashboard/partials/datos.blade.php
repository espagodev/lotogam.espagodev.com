             ...
             <div class="card-body">
                 ...
                 <div class="card-title">Reporte de venta mes Actual
                     <div class="card-action">
                         <a href="#" type="button" class="print-invoice"
                             data-href="{{ action('HomeController@getVentasMesPrint') }}">
         ...
         <div class="card">
             <div class="card-body">
                 <div class="card-title">Resultados
                     <div class="card-action">
                      <a type="button" class="btnGenerarResultados"><i class="fa fa-file-image-o"></i></a>
                         <a type="button" class="resultados_print"
                             data-href="{{ action('ResultadosController@getResultadosFechaPrint') }}">
                             <i class="fa fa-print"></i>
                         </a>
                     </div>
                 </div>
                 ...
                 <div class="table-responsive">
                     <table class="table table-sm" id="resultado_fecha">
                         <thead>
                             <tr>
                                 <th>Loteria</th>
                                 <th>Resultados</th>
