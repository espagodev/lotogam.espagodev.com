<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content border-info">
        ...
        <div class="modal-header bg-info">
            <h3 class="modal-title text-white">Modificar Opciones de Impresión</h3>
        ...
        <form method="post" action="{{ route('updateAjustesImpresion',$banca->id) }}"  id="opciones_impresora_pos">
         @csrf {{method_field('PUT')}}
         <div class="modal-body">
               @include('impresora.updateImpresora')
        </div>
