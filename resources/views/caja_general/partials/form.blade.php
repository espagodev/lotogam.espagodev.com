                                ...
                                <div class="row">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="input-group">
                                                <div class="input-group-prepend">
                                                 ...
                                                 <input class="form-control{{ $errors->has('cag_fecha_movimiento') ? ' is-invalid' : '' }}" name="cag_fecha_movimiento" id="cag_fecha_movimiento" type="text" value="{{ @format_datetime('now')  }}"  readonly required>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <div class="form-group">
                                            <strong>Monto:</strong>
                                            <input class="form-control{{ $errors->has('cag_monto') ? ' is-invalid' : '' }}" name="cag_monto" id="cag_monto" type="text" value="{{ @num_format(old('cag_monto')) }}" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                           <div class="form-group">
                                                ...
                                                <textarea rows="4" class="form-control" name="cag_nota_movimiento" id="cag_nota_movimiento" ></textarea>
                                            </div>
                                        </div>
