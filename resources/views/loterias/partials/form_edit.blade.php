            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-md-8">
                    <label >Nombre</label>
                    <input class="mb-3 form-control{{ $errors->has('lot_nombre') ? ' is-invalid' : '' }}" type="text" id="lot_nombre" name="lot_nombre" value="{{ old('lot_nombre',$loteria->lot_nombre ) }}" required>
                </div>
            ...
            <div class="row">
              ...
              <div class="row">
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            ...
                            <input id="lot_horario_cierre_ls" type="text" class="mb-3 form-control{{ $errors->has('lot_horario_cierre_ls') ? ' is-invalid' : '' }}"   name="lot_horario_cierre_ls" value="{{ old('lot_horario_cierre_ls',$loteria->lot_horario_cierre_ls) }}" required>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <label >Horario Cierre Domingo</label>
                            <input id="lot_horario_cierre_d" type="text" class="mb-3 form-control{{ $errors->has('lot_horario_cierre_d') ? ' is-invalid' : '' }} "   name="lot_horario_cierre_d" value="{{ old('lot_horario_cierre_d',$loteria->lot_horario_cierre_d) }}"  required>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <label >Minutos antes de Cierre</label>
                            <input id="lot_minutos_cierre" type="number" class="mb-3 form-control{{ $errors->has('lot_minutos_cierre') ? ' is-invalid' : '' }} "   name="lot_minutos_cierre" value="{{ old('lot_minutos_cierre',$loteria->lot_minutos_cierre) }}"  required>
                        </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <input id="lot_comision" type="number" class="mb-3 form-control{{ $errors->has('lot_comision') ? ' is-invalid' : '' }}"   name="lot_comision" value="{{ old('lot_comision',$loteria->lot_comision ) }}" >
                </div>
                <div class="col-xs-12 col-sm-4 col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="lot_jornada" id="lot_jornada" >
                            <option value="">Seleccione</option>
                                ...
                                <option value="{{ $key }}" @if($key == old('lot_jornada', $loteria->lot_jornada)) selected @endif>{{ $jornada }}</option>
                                @endforeach
                        </select>
                    </div>
                </div>
