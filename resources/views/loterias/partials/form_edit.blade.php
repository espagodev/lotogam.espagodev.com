    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
            <label >Codigo</label>
            <input id="lot_codigo" type="text" class="mb-3 form-control{{ $errors->has('lot_codigo') ? ' is-invalid' : '' }}"   name="lot_codigo" value="{{ old('lot_codigo',$loteria->lot_codigo) }}" required>
        </div>
    </div>
      {{-- <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-6">
