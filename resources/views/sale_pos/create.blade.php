                            ...
                            @if ($parametros->ban_venta_futuro == 1)
                                <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="tic_fecha_sorteo" class="form-control"
                                            name="tic_fecha_sorteo" value="{{ $fechaActual }}"
                        ...
                        <div class="row">
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" id="tid_valor" name="tid_valor" class="form-control"
                            ...
                            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" name="tid_apuesta" id="tid_apuesta" class="form-control"
                                        placeholder="Numero">
                                </div>
                            </div>
                        </div>
                                ...
                                <table class="table table-condensed  table-responsive" id="pos_table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center col-3 col-sm-3 col-md-3 col-lg-1 col-xl-1"><i
                                                    class="fa fa-close" aria-hidden="true"></i></th>
                                        </tr>
                                    </thead>
                                    <tbody></tbody>
                                </table>
...
<div class="modal fade close_register_modal no-print" tabindex="-1" role="dialog"  aria-labelledby="gridSystemModalLabel">
</div>

@endsection
@include('sale_pos.partials.tickets_modal')

@include('sale_pos.partials.generar_modal')
