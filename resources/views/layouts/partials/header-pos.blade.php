...
<div class="no-print pos-header">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-xs-12">
            <div class="row">
                <div class="col-12 col-sm-6 col-md-6 col-xs-12"><h5>POS Loterias <i class="fa fa-keyboard-o hover-q text-muted"></i></h5></div>

                <div class="col-12 col-sm-6 col-md-6 col-xs-12">
                    <div class="row">
                         <div class="col-5 col-sm-5 col-md-5  col-xs-12 ">
                            <button type="button" class="btn btn-sm  btn-primary btn-flat" data-toggle="modal" data-target="#recent_transactions_modal" id="recent-transactions"> <i class="fa fa-clock-o"></i> Tickets Recientes</button>
                        </div>
                        ...
                        <div class="col-4 col-sm-4 col-md-4  col-xs-12">
