                    ...
                    <strong><i class="fa fa-clock-o"></i> Zona Horaria:</strong> 
                         <select class="form-control  single-select" name="emp_zona_horaria" id="emp_zona_horaria" required>
                            <option value="">Seleccione</option>
                                ...
                                <option value="{{ $zonaHoraria }}" @if($zonaHoraria == old('time_zone', $empresa[0]->emp_zona_horaria)) selected @endif>{{ $zonaHoraria }}</option>
                                @endforeach
                        </select>
                </div>
            </div>
                    ...
                    <strong><i class="fa fa-money"></i> Moneda:</strong>
                          <select class="form-control single-select" name="monedas_id" id="monedas_id" required>
                            <option value="">Seleccione</option>
                                ...
                                <option value="{{ $moneda->id }}" @if($moneda->id == old('moneda', $empresa[0]->monedas_id)) selected @endif>{{ $moneda->pais }} - {{ $moneda->moneda }} ({{ $moneda->codigo }})  </option>
                                @endforeach
                        </select>
                </div>
            </div>
                    ...
                    <strong><i class="fa fa-arrows-h"></i> Ubicacion Simbolo de Moneda:</strong>
                         <select class="form-control " name="emp_ubicacion_simbolo_moneda" id="emp_ubicacion_simbolo_moneda" required>
                            <option value="">Seleccione</option>
                                ...
                                <option value="{{ $key }}" @if($key == old('currency_symbol_placement', $empresa[0]->emp_ubicacion_simbolo_moneda)) selected @endif>{{ $ubicacionSiombolo }}</option>
                                @endforeach
                        </select>
                </div>
            </div>
                        ...
                        <div class="input-group-prepend">
                         ...
                         <select class="form-control" name="emp_formato_fecha" id="emp_formato_fecha" required>
                            <option value="">Seleccione</option>
                                ...
                                <option value="{{ $key }}" @if($key == old('date_format', $empresa[0]->emp_formato_fecha)) selected @endif>{{ $formatoFecha }}</option>
                                @endforeach
                        </select>
                    </div>
                </div>
                      ...
                      <div class="input-group">
                        ...
                        <select class="form-control " name="emp_formato_hora" id="emp_formato_hora" required>
                            <option value="">Seleccione</option>
                                ...
                                <option value="{{ $key }}" @if($key == old('time_format', $empresa[0]->emp_formato_hora)) selected @endif>{{ $formatoHora }}</option>
                                @endforeach
                        </select>
                    </div>
                </div>
