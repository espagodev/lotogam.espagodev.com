<div class="modal-dialog modal-xl" role="document">
        <div class="modal-content border-warning">
            ...
            <form method="post" action="{{ route('bancaLoterias.update',$loteria->id) }}"  id="store">
             @csrf {{method_field('PUT')}}
                <div class="modal-body">
                    <input type="hidden" id="bancas_id" name="bancas_id" value="{{ $banca }}">
                    @include('ajustesBanca.loterias.partials.form_edit')
                </div>
