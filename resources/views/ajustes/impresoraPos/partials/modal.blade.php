        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('impresoraPos.store')}}">
                    @include('ajustes.impresoraPos.partials.form')
                </div>
     ...
     {{-- <div class="modal fade" id="actualizar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('impresoraPos.update',$impresora->id )}}">
                    {{method_field('PUT')}}
