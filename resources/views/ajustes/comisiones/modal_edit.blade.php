<div class="modal-dialog" role="document">
        <div class="modal-content border-warning">
            ...
            <div class="modal-header bg-warning">
                <h3 class="modal-title text-white">Modificar Comision</h3>
            ...
            <form method="post" action="{{ route('comisiones.update', $comision->id)}}"  id="store">
             @csrf {{method_field('PUT')}}
                <div class="modal-body">
                    @include('ajustes.comisiones.partials.form_edit')
                </div>
