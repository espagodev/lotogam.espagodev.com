<div class="modal-dialog" role="document">
        <div class="modal-content border-warning">
            ...
            <div class="modal-header bg-warning">
                <h3 class="modal-title text-white">Modificar Monto Global</h3>
            ...
            <form method="post" action="{{ route('montosGlobales.update', $montoGlobal->id)}}"  id="store">
             @csrf {{method_field('PUT')}}
                <div class="modal-body">
                    @include('ajustes.montosG.partials.form_edit')
                </div>
