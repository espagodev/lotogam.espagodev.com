<div class="modal-dialog" role="document">
        <div class="modal-content border-warning">
            ...
            <div class="modal-header bg-warning">
                <h3 class="modal-title text-white">Modificar Traslado</h3>
            ...
            <form method="post" action="{{ route('numerosTraslado.update', $traslado->id)}}"  id="store">
             @csrf {{method_field('PUT')}}
                <div class="modal-body">
                    @include('ajustes.numerosTraslado.partials.form_edit')
                </div>
