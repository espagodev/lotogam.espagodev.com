<div class="modal-dialog" role="document">
        <div class="modal-content border-info">
            ...
            <div class="modal-header bg-info">
                <h3 class="modal-title text-white">Nuevo Traslado</h3>
            ...
            <form method="post" action="{{ route('numerosTraslado.store')}}"  id="store">
             @csrf
             <div class="modal-body">
                   @include('ajustes.numerosTraslado.partials.form_create')
            </div>
