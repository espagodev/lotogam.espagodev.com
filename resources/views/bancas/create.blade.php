    ...
    @section('content')
        ...
        <div class="col-sm-3">
            <div class="btn-group float-sm-right">
                 <a href="{{ route('bancas.index') }}"  class="btn btn-danger waves-effect waves-danger"><i class="fa fa-times mr-1"></i> Regresar</a>
            </div>
        </div>
     </div>


        <form action="{{ route('bancas.store') }}" method="post" id="store">
            @csrf
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control{{ $errors->has('ban_telefono') ? ' is-invalid' : '' }}" name="ban_telefono" id="ban_telefono" type="text" value="{{ old('ban_telefono') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control{{ $errors->has('ban_direccion') ? ' is-invalid' : '' }}" name="ban_direccion" id="ban_direccion" type="text" value="{{ old('ban_direccion') }}" required>
                    ...
                    <div class="card">
                              ...
                              <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control{{ $errors->has('ban_tiempo_cobro') ? ' is-invalid' : '' }}" name="ban_tiempo_cobro" id="ban_tiempo_cobro" type="text" value="{{ old('ban_tiempo_cobro') }}" required>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control{{ $errors->has('ban_limite_venta') ? ' is-invalid' : '' }}" name="ban_limite_venta" id="ban_limite_venta" type="text" value="{{ old('ban_limite_venta') }}" required>
                                        </div>
                                    </div>
                                </div>
                     ...
                     <div class="form-footer">
                         <a href="{{ route('bancas.index') }}"  class="btn btn-danger waves-effect waves-danger"><i class="fa fa-times"></i> cancelar</a>
